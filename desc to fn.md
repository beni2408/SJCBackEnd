...
these are all the details from the backend. just complete the frond end app for this using redux and react. and tailwind css i completely surrender this repo to you
